  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        scale={0.738}
      />
      <mesh castShadow receiveShadow geometry={nodes.nintendobase.geometry} material={materials.Material} position={[0.001, 1.943, 0.033]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.NIN.geometry} material={materials.Material} position={[0.001, 1.939, 0.033]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.botones.geometry} material={materials.Material} position={[0.001, 1.911, 0.033]} scale={0.738} />
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={0.738}
      />
      <mesh castShadow receiveShadow geometry={nodes.Circle.geometry} material={materials.Material} position={[-0.701, 1.739, 0.591]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.Circle001.geometry} material={materials.Material} position={[-0.611, 1.727, -0.542]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.Circle002.geometry} material={materials.Material} position={[0.618, 1.727, -0.542]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.Circle003.geometry} material={materials.Material} position={[0.709, 1.739, 0.577]} scale={0.738} />
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={0.826}
      />
      <group position={[-1.897, 2.024, 0.241]} rotation={[0.054, 0.267, -0.014]} scale={0.826}>
        <mesh castShadow receiveShadow geometry={nodes.Circle009.geometry} material={materials['Material.009']} />
        <mesh castShadow receiveShadow geometry={nodes.Circle009_1.geometry} material={materials['Material.005']} />
      </group>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={0.826}
      />
      <group position={[1.886, 2.024, 0.148]} rotation={[0.056, -0.342, 0.019]} scale={0.826}>
        <mesh castShadow receiveShadow geometry={nodes.Circle011.geometry} material={materials['Material.009']} />
        <mesh castShadow receiveShadow geometry={nodes.Circle011_1.geometry} material={materials['Material.005']} />
      </group>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={0.094}
      />
      <mesh castShadow receiveShadow geometry={nodes.Caset_B.geometry} material={materials['Material.003']} position={[0.001, 2.312, -0.47]} scale={0.738} />
      <mesh castShadow receiveShadow geometry={nodes.Caset_F.geometry} material={materials['Material.003']} position={[0.001, 2.312, -0.47]} scale={0.738} />
      <mesh
        castShadow
        receiveShadow
      ...
      <group position={[0, 3.577, -1.414]}>
        <mesh castShadow receiveShadow geometry={nodes.Cube011.geometry} material={materials['Plastic Base 01']} />
        <mesh castShadow receiveShadow geometry={nodes.Cube011_1.geometry} material={materials['Material.011']} />
      </group>
    </group>
  )
}
